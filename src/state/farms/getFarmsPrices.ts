...
const getFarmQuoteTokenPrice = (
  ...
  if (farm.quoteToken.symbol === 'QUSD') {
    return BIG_ONE
  }

  if (farm.quoteToken.symbol === 'WAME') {
    return bnbPriceBusd
  }
  ...
  if (quoteTokenFarm.quoteToken.symbol === 'WAME') {
    return quoteTokenFarm.tokenPriceVsQuote ? bnbPriceBusd.times(quoteTokenFarm.tokenPriceVsQuote) : BIG_ZERO
  }

  if (quoteTokenFarm.quoteToken.symbol === 'QUSD') {
...
const getFarmsPrices = (farms: SerializedFarm[]) => {
  const bnbBusdFarm = farms.find((farm) => farm.token.symbol === 'QUSD' && farm.quoteToken.symbol === 'WAME')
