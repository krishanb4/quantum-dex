  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active QuantumDex Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold QTM'),
      bodyText: [t('Each NFT costs QTM to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://quantumdex.finance/swap?outputCurrency="
            target="_blank"
            width="100%"
          >
            {t('Buy QTM')}
