  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on QuantumDex.'),
      ],
    },
    {
      ...
      description: [
        t(
          'Soon! The current NFT Market is a basic version (phase 1), with early access to trading QuantumDex NFTs only.',
        ),
    ...
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.quantumdex.finance/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by QuantumDex from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
